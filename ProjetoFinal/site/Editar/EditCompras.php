...
<div class='form-row'>
    <div class='col-md-1 mb-1'>
      ...
      <input type='text' class='form-control' name='Compras_CodForn' value='".$linha['CodForn']."' readonlyd>
    </div>
    <div class='col-md-3 mb-1'>
      <label for='validationCustom01'>CodArtigo</label>
      <input type='text' class='form-control' name='Compras_CodArtigo' value='".$linha['CodArtigo']."' required>
    </div>

		<div class='col-md-1 mb-3'>
			<label for='validationCustom01'>Data</label>
			<input type='date' class='form-control' name='Compras_data' value='".$linha['data']."' required>
		</div>

		<div class='col-md-1 mb-3'>
			<label for='validationCustom01'>Preço</label>
			<input type='text' class='form-control' name='Compras_Preco' value='".$linha['Preco']."' required>
		</div>

		<div class='col-md-1 mb-3'>
			<label for='validationCustom01'>Quantidade</label>
			<input type='text' class='form-control' name='Compras_Quantidade' value='".$linha['Quantidade']."' required>
		</div>
