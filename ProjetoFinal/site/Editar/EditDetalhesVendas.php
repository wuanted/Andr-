...
<div class='form-row'>
    <div class='col-md-1 mb-1'>
      ...
      <input type='text' class='form-control' name='DetalhesVendas_NFactura' value='".$linha['NFactura']."' readonly>
    </div>
    <div class='col-md-3 mb-1'>
      <label for='validationCustom01'>CodArtigo</label>
      <input type='text' class='form-control' name='DetalhesVendas_CodArtigo' value='".$linha['CodArtigo']."' required;>
    </div>

		<div class='col-md-1 mb-3'>
			<label for='validationCustom01'>Quantidade</label>
			<input type='text' class='form-control' name='DetalhesVendas_Quantidade' value='".$linha['Quantidade']."' required>
		</div>
