...
<div class='form-row'>
		...
		<div class='col-md-1 mb-3'>
			...
			<input type='text' class='form-control' name='DetalhesVendas_CodArtigo' required>
		</div>

		<div class='col-md-1 mb-3'>
			<label for='validationCustom01'>Quantidade</label>
			<input type='text' class='form-control' name='DetalhesVendas_Quantidade' required>
		</div>
