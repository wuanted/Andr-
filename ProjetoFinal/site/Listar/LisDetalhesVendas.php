...
while ($linha = mysqli_fetch_array($listagem)) {
	...
	echo "<tr>
					...
					<td><a href='/fichas/ProjetoFinal/site/Editar/Edit".$tabela.".php?id=".$linha['NFactura']."'\><img src='/fichas/ProjetoFinal/site/img/edit.png' width='20' height='20'></a>
					<a href='/fichas/ProjetoFinal/site/Remover/rem.php?id=".$linha['NFactura']."&tabela=".$tabela."'\><img src='/fichas/ProjetoFinal/site/img/delete.png' width='20' height='20'></a></td></tr>";
}
 ?>
</tr>
</tbody>
